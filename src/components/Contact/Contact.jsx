  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card animate-link">
              ...
              <span className="contact__card-data">rahyanakil89@gmail.com</span>
              <a
            ...
            <div className="contact__card animate-link">
              ...
              <span className="contact__card-data">+8801811380844</span>
              <a
        ...
        <div className="contact__content">
          <h3 className="contact__title">Write me your project details</h3>
