...
import Resume from "../../assets/RAHYAN AKIL RESUME.pdf";
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title animate-charcter">Rahyan Shamsi Akil</h1>
      <h3 className="home__subtitle animate-charcter">MERN STACK Developer</h3>
